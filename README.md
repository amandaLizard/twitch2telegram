Чтобы запустить бота, нужны 4 вещей:
  1. Linux
...
2.2. У требоемого телеграмм канала нужно узнать ID, он выглядит примерно так: -1001273091133
(строчки 12-13)
...
```
  ...
  TELEGRAM_CHAT_ID: "-1001273091133"
```
